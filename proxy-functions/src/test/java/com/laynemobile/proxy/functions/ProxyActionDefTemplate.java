...
public class ProxyActionDefTemplate extends AbstractFunctionDefTemplate {
    private static final String FILE_NAME_TEMPLATE = "ProxyAction${LENGTH}Def";

    public ProxyActionDefTemplate(int length) {
    ...
    private static final String TEMPLATE = "" +
            ...
            "\n" +
            "public class ${FILE_NAME}<P, ${TYPE_ARGS}> extends ProxyActionDef<P, ProxyAction${LENGTH}Transform<P, ${TYPE_ARGS}>> {\n" +
            "    public ${FILE_NAME}(String name, ${TYPE_TOKEN_PARAMETERS}) {\n" +
