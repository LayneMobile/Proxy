...
public class ProxyFuncDefTemplate extends AbstractFunctionDefTemplate {
    private static final String FILE_NAME_TEMPLATE = "ProxyFunc${LENGTH}Def";

    public ProxyFuncDefTemplate(int length) {
    ...
    private static final String TEMPLATE = "" +
            ...
            "\n" +
            "public class ${FILE_NAME}<P, ${TYPE_ARGS}, R> extends ProxyFunctionDef<P, ProxyFunc${LENGTH}Transform<P, ${TYPE_ARGS}, R>, R> {\n" +
            "    public ${FILE_NAME}(String name, TypeToken<R> returnType, ${TYPE_TOKEN_PARAMETERS}) {\n" +
